...
1. **Стартовый экран:**
   - Игра начинается со стартового экрана, на котором расположено главное меню. Поле для авторизации / регистрации, лидерборд.
...
6. **Улучшения:**
    <br/> *Улучшения доступны по достижении нового уровня.*
