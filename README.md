...
2. **Игровой процесс:**
   - После нажатия кнопки "Играть", игрок попадает на игровое бесконечное поле, по которому нужно двигаться при помощи четырех кнопок на клавиатуре: W, A, S, D.
...
6. **Улучшения:**
   ...
   - При покупке улучшения "Thanos snap" умирает половина всех врагов.
   - При покупке улучшения "Огнемет" на 10 секунд игрок получает высокую скорость перезарядки и большой урон от пуль.
...
- **Игра окончена:** Всплывает при смерти игрока, с возможностью вернуться к стартовому экрану.
